      ...
      <section id="chuyen-di">
        ...
        <div class="bg-white p-4 rounded shadow">
          <form class="space-y-2 mb-4" method="POST">
            <input type="text" placeholder="Nhà xe cung cấp dịch vụ" class="w-full border p-2 rounded" name="nhaxe">
            <input type="text" placeholder="Điểm khởi hành" class="w-full border p-2 rounded" name="diemKH">
            <input type="text" placeholder="Điểm kết thúc" class="w-full border p-2 rounded" name="diemKH">
            <input type="text" placeholder="Lịch trình" class="w-full border p-2 rounded" name="lichTrinh">
            <input type="text" placeholder="Giá vé" class="w-full border p-2 rounded" name="gia">
            <input type="submit" class="bg-blue-600 text-white px-4 py-2 rounded" value="Thêm chuyến">
          </form>
          <ul class="divide-y">
            <li class="py-2 flex justify-between items-center">
              <span>Nhà xe ABC | Hà Nội - Sài Gòn 08:00 | Còn ghế | 500.000đ</span>
              <div class="space-x-2">
